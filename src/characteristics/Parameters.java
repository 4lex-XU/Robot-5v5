...
public class Parameters {
  ...
  public static final String teamBMainBotBrainClassName = "algorithms.exemples.Mule"; //class given by name; is supposed to extends robotsimulator.Brain
  ...
  public static final String teamBSecondaryBotBrainClassName = "algorithms.exemples.Mule"; //class given by name; is supposed to extends robotsimulator.Brain
